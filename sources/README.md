...
Projet qui est utilisé comme plugin MIRO.
Il est deployé sur **QUALIF**, car MIRO a besoin de télécharger le JS de ce projet (uniquement depuis le naviguateur de l'utilisatuer, donc pas besoin d'internet)
